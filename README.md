...
Step 1: Click On File > Import > Git > Projects From Git > Clone Uri  > Paste The Repository Url: ```https://github.com/sangeeta-meher/Train-ticket-reservation-system.git``` > Next > Select Master Branch > Next > Finish
